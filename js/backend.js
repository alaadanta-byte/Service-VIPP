...
(function() {
  ...
  const defaultServices = [
    {
      ...
      nameAr: 'ChatGPT Plus',
      nameEn: 'ChatGPT Plus',
      descAr: 'الوصول إلى GPT-4o وأحدث المميزات',
      descEn: 'Access to GPT-4o and latest features',
      categoryId: 1,
      originalPrice: 20.00,
      price: 9.99,
      period: 'شهر',
    ...
    },
    {
      ...
      nameAr: 'Claude Pro',
      nameEn: 'Claude Pro',
      descAr: 'Claude 3 Opus أداء متقدم',
      descEn: 'Claude 3 Opus advanced performance',
      categoryId: 1,
      originalPrice: 20.00,
      price: 9.99,
      period: 'شهر',
    ...
    },
    {
      ...
      nameAr: 'Midjourney',
      nameEn: 'Midjourney',
      descAr: 'إنشاء صور احترافية بالذكاء الاصطناعي',
      descEn: 'Professional AI image generation',
      categoryId: 1,
      originalPrice: 20.00,
      price: 9.99,
      period: 'شهر',
    ...
    },
    {
      ...
      iconType: 'gemini',
      nameAr: 'Gemini Advanced',
      nameEn: 'Gemini Advanced',
      descAr: 'Gemini 1.5 Pro من Google',
      descEn: 'Gemini 1.5 Pro from Google',
      categoryId: 1,
      originalPrice: 20.00,
      price: 9.99,
      period: 'شهر',
    ...
    },
    {
      ...
      descAr: 'بحث ذكي بمصادر موثوقة',
      descEn: 'Smart AI search with reliable sources',
      categoryId: 1,
      originalPrice: 20.00,
      price: 9.99,
      period: 'شهر',
  ...
  const defaultUsers = [
    ...
    { id: 2, name: 'سارة علي', nameEn: 'Sara Ali', email: 'sara@example.com', status: 'active', joinDate: '2026-04-20' },
    { id: 3, name: 'محمد عبد الله', nameEn: 'Mohammed Abdullah', email: 'mohammed@example.com', status: 'active', joinDate: '2026-05-10' }
  ];

  const defaultOrders = [
    { id: 1038, userId: 3, serviceId: 1, amount: 9.99, status: 'active', date: '2026-06-24' },
    { id: 1039, userId: 2, serviceId: 2, amount: 9.99, status: 'active', date: '2026-06-23' },
    { id: 1040, userId: 1, serviceId: 3, amount: 9.99, status: 'active', date: '2026-06-25' }
  ];

  const defaultComplaints = [
    { id: 1001, name: 'محمد أحمد', email: 'mohammed@example.com', phone: '+966501234567', orderNumber: '#1035', subject: 'استفسار عن اشتراك', details: 'كيف يمكن تفعيل حساب Midjourney؟', status: 'resolved', date: '2026-06-20', reply: 'تم التفعيل بنجاح' }
  ];

  const defaultReviews = [
    { id: 1, nameAr: 'محمد عبد الله', nameEn: 'Mohammed Abdullah', roleAr: 'عميل مميز', roleEn: 'VIP Client', textAr: '"من أفضل المناجر لشراء اشتراكات الذكاء الاصطناعي"', textEn: '"One of the best stores to buy AI subscriptions"', rating: 5, avatar: 'م', serviceId: 1 },
    { id: 2, nameAr: 'سارة علي', nameEn: 'Sara Ali', roleAr: 'عميلة مميزة', roleEn: 'VIP Client', textAr: '"اشتراك رسمي 100% والدعم سريع ومميز جداً."', textEn: '"100% official subscription, fast and exceptional support."', rating: 5, avatar: 'س', serviceId: 2 },
    { id: 3, nameAr: 'أحمد محمد', nameEn: 'Ahmed Mohammed', roleAr: 'عميل مميز', roleEn: 'VIP Client', textAr: '"أسعار ممتازة وتسليم فوري، أنصح بالتعامل معهم ."', textEn: '"Great prices and instant delivery, highly recommended."', rating: 5, avatar: 'أ', serviceId: 3 }
  ];
